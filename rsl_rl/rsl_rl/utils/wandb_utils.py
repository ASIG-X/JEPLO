...
class WandbSummaryWriter(SummaryWriter):
    ...
    def add_images(self, tag, img_tensor, global_step=None, walltime=None, dataformats="NCHW"):
        ...
        # wandb.Image expects individual images, so log as a list for batched images
        images = [wandb.Image(img) for img in img_tensor]
        wandb.log({self._map_path(tag): images}, step=global_step)
